    ...
    <div className='form-container'>
      <form onSubmit={createNewBlog}>
        ...
        <div className="form-group">
          ...
          <textarea name="blog_text" id="blog_text" cols="30" rows="10" placeholder='Tell your story' value={newBlog.content} onChange={(e) => setNewBlog({ ...newBlog, [e.target.name]: e.target.value })}></textarea>
        </div>
        <div className="form-group">
